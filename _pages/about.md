...
2. **On the Perception Bottleneck of VLMs for Chart Understanding.** Arxiv, 2025.
   Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. (Code: Vision4Chart)

3. **On the Universal Truthfulness Hyperplane Inside LLMs.** EMNLP 2024.
   Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He. (Code: Universal_Truthfulness_Hyperplane)
...
- **Google Scholar:** [Junteng Liu's Google Scholar profile](https://scholar.google.com/citations?hl=en&user=tbK9jl4AAAAJ&view_op=list_works&sortby=pubdate)
